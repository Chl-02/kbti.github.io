...
const PostPage = (props) => {
  ...
  const getList = useCallback(async () => {
    ...
    await axios
      .get(saju_url + `/today/total`, { withCredentials: true })
      .then((res) => {
        console.log(res);
      });
    await axios
  ...
  const metaTagRenderer = () => {
    return (
      <Helmet>
        ...
        <meta
          name='description'
          content='나만의 퍼스널 우체통 2022'
          data-react-helmet='true'
        />
        <link
          rel='main-url'
          href='https://ktestone.com/kapable.github.io/post2022/'
        />
        ...
        <meta
          property='og:url'
          content='https://ktestone.com/kapable.github.io/post2022/'
        />
  ...
  const nullMailRenderer = () => {
    return <div className='post-page-null-maillist'>{`텅! 비었어요...`}</div>;
  };

  const eachMail = (
    <div className='post2022-popup'>
      <div className='post2022-popup-inner'>
        ...
        <p className='post2022-popup-fromNickname'>
          From : {`${fromNickname}`}
        </p>
        <p className='post2022-popup-head'>To: {`${userNickname}`}</p>
        <button
          onClick={() => setShowPopup(false)}
          className='post2022-popup-close-btn'
        >
          X
        </button>
      </div>
  ...
  if (isLogin && user) {
    ...
    return (
      <div className='post2022-page'>
        ...
        <img
          loading='lazy'
          src={postListBackgroundImg}
          alt='bg-img'
          className='post2022-long-bg-img'
        />
        ...
        <img
          ...
          src={alertBellImg}
          alt='alertBellImg'
          className='post2022-alert-bell-img'
        />
        ...
        <div className='post2022-page-btn-div'>
          <CopyToClipboard
            text={`https://ktestone.com/kapable.github.io/post2022/${props.match.params.username}/`}
          >
            <img
              loading='lazy'
              src={shareMyBox}
              ...
              className='post2022-page-share-mypost-btn'
            />
          </CopyToClipboard>
        </div>
        {/* Contents */}
        ...
        <div className='post2022-popup-div'>{ShowPopup ? eachMail : null}</div>
      </div>
    );
  } else {
    return (
      <div className='post2022-page'>
        ...
        <div className='post2022-page-btn-div'>
          <img
            ...
            src={sendButtonImg}
            alt='Send Mail'
            className='post2022-page-send-mail-btn'
            onClick={() => {
              _eventSenderGA(
                'Paging',
