    ...
    <div className='post2022-popup'>
      <div className='post2022-popup-inner'>
        <img
          ...
          src={completePopupBg}
          alt='메시지 보내기 완료!'
          className='post2022-postwrite-send-complete-postbox'
        />
        <img
          loading='lazy'
        ...
        />
        <Link
          to={`/post2022/${encodeURIComponent(key)}/`}
    ...
    <div className='post2022-write-page-div'>
      <div className='post2022-write-page-postbox-div'>
        <img
          ...
          className='post2022-write-page-letter-form-img'
        />
        <form
        ...
        >
          ...
          />
          <p className='post2022-write-page-whosname'>
            To: {`${userNickname}`}님에게
          </p>
          <Input
            prefix={'From: '}
          ...
          <button type='submit' className='post2022-write-page-submit-btn'>
            <img
              ...
              src={sendMailBtnImg}
              alt='submit letter'
              className='post2022-write-page-submit-btn-img'
            />
          </button>
        </form>
      </div>
