  ...
  async function onSubmitHandler(e) {
    ...
    await axios
      ...
      .then(() => {
        ...
        axios.get(api_url + '/auth/me').then((response) => {
          navigate({
            pathname: `/post2022/${encodeURIComponent(response.data.key)}/`,
            options: { state: response.data.accessToken },
          });
        });
      })
      .catch(() => {
  ...
  return (
    <div className='post2022-login-page-bg-div'>
      <img
        ...
        src={bgImgSrc}
        alt='register-bg'
        className='post2022-register-page-bg-img'
      />
      <div className='post2022-login-page-contents-div'>
        <div className='post2022-register-page-btn-div'>
          <button
            ...
            className='post2022-login-page-rgbtn'
          >
            회원가입
          </button>
          <button
            ...
            className='post2022-login-page-loginbtn'
          >
            로그인
          </button>
        </div>
