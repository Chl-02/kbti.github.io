    ...
    if (props.language === `Kor`) {
      ...
      let _PostMetaTag = (
        <Helmet>
          ...
          <meta
            name='description'
            content='My Persoanl Mailbox'
            data-react-helmet='true'
          />
          <link
            rel='main-url'
            href='https://ktestone.com/kapable.github.io/post2022Eng/'
          />
          ...
          <meta
            property='og:url'
            content='https://ktestone.com/kapable.github.io/post2022Eng/'
          />
          ...
          <meta
            property='twitter:image:alt'
            content='Persoanl Mailbox - K-test'
          />
        </Helmet>
      );
      return _PostMetaTag;
