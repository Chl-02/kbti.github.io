...
const TodayLuck = (props) => {
  ...
  const onSubmitClick = useCallback(async () => {
    ...
    const crypto_query_date = encodeURIComponent(
      crypto.AES.encrypt(JSON.stringify(query_date), 'ktestsaju').toString()
    );

    setIsLoading(true);
    setTimeout(() => {
      navigate(`/todayLuck/${crypto_query_date}/`);
    }, '2500');
  }, [day, navigate]);
    ...
    return (
      <Fragment>
        <Helmet>
          ...
          <meta
            name='description'
            content='오늘 하루 나의 총운은? - 오늘의 총운 | 케이테스트 | 사주 테스트'
            data-react-helmet='true'
          />
          <link
            rel='main-url'
            href='https://ktestone.com/kapable.github.io/todayLuck/'
          />
          ...
          <meta
            property='og:url'
            content='https://ktestone.com/kapable.github.io/todayLuck/'
          />
          <meta
            property='og:title'
            content='오늘의 총운 - 케이테스트 | 사주 테스트'
          />
          <meta
        ...
        <div className='todayLuck-intro-img-div'>
          ...
          <div className='todayLuck-intro-date-picker-div'>
            <DatePicker
              className='todayLuck-intro-date-picker'
              onChange={onChange}
              allowClear
              locale={locale}
            />
