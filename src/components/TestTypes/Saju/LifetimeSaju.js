...
const LifetimeSaju = (props) => {
  ...
  const onSubmitClick = useCallback(async () => {
    ...
    setIsLoading(true);
    setTimeout(() => {
      navigate(`/lifetimeSaju/${crypto_query_date}/`);
    }, '2500');
  }, [day, navigate]);
    ...
    return (
      <Fragment>
        <Helmet>
          ...
          <meta
            name='description'
            content='무료 사주를 케이테스트에서 제공합니다. | 나의 평생 총운은? - 자평명리학 | 평생 총운 | 케이테스트 | 사주 테스트'
            data-react-helmet='true'
          />
          <link
            rel='main-url'
            href='https://ktestone.com/kapable.github.io/lifetimeSaju/'
          />
          ...
          <meta
            property='og:url'
            content='https://ktestone.com/kapable.github.io/lifetimeSaju/'
          />
          <meta
            property='og:title'
            content='사주 총평 당신의 사주는? - 케이테스트 | 사주 테스트'
          />
          <meta
        ...
        <div className='lifetime-saju-intro-img-div'>
          ...
          <div className='lifetime-saju-intro-date-picker-div'>
            <DatePicker
              className='lifetime-saju-intro-date-picker'
              onChange={onChange}
              allowClear
              locale={locale}
            />
          ...
          <div className='lifetime-saju-intro-time-picker-div'>
            <Select
              className='lifetime-saju-intro-time-picker'
              defaultValue={'시간 모름'}
          ...
          <div className='lifetime-saju-intro-gender-picker-div'>
            <Radio.Group
              className='lifetime-saju-intro-gender-picker'
              defaultValue='female'
              buttonStyle='solid'
            >
